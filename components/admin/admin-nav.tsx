...
import { LayoutDashboard, Calendar, Users, BarChart3, FileText, Settings, LogOut } from "lucide-react"
  ...
  return (
    <div className="flex h-full w-64 flex-col bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700">
      <div className="flex h-16 items-center px-6 border-b border-gray-200 dark:border-gray-700">
        <h1 className="text-xl font-bold text-emerald-900 dark:text-emerald-500">Admin Panel</h1>
      </div>
