                      ...
                      recentActivity.map((activity) => (
                        <div key={activity.id} className="flex items-center space-x-4 p-3 rounded-lg bg-muted/50">
                          <Avatar className="h-10 w-10">
                            <AvatarImage src={activity.user?.profile_picture_url || ""} />
                          ...
                          <div className="flex-1 min-w-0">
                            <div className="flex items-center space-x-2 mb-1">
                              ...
                              {getActivityBadge(activity.action_type || activity.entity_type || activity.action)}
                            </div>
                            <p className="text-sm text-muted-foreground">
                              {activity.description || activity.details?.description || activity.entity_type || ""}
                            </p>
                        ...
                        <div key={event.id} className="flex items-start gap-3 p-3 rounded-lg bg-muted/50">
                          ...
                          <div className="flex-1">
                            ...
                            <p className="text-xs text-muted-foreground">
                              {new Date(event.event_date || event.start_date).toLocaleDateString("en-NG", {
                                weekday: "short",
                                month: "short",
                                day: "numeric",
                              })}
                  ...
                  <CardContent>
                    <div className="grid grid-cols-2 gap-3">
                      ...
                      >
                        ...
                        <span className="text-sm font-medium">View Donations</span>
                      </Link>
                      <Link
