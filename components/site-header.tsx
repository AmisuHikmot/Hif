...
import { PrayerTimesBanner } from "@/components/prayer/prayer-times-banner"
                ...
                <DropdownMenuTrigger asChild>
                  <button className="h-9 w-9 rounded-full ring-2 ring-transparent hover:ring-emerald-500/40 transition-all">
                    <Avatar className="h-9 w-9">
                      <AvatarImage src={profile?.profile_picture_url || profile?.avatar_url || undefined} />
