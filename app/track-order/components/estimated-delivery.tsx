...
export function EstimatedDelivery({
  ...
  // Auto-show support panel if overdue
  useEffect(() => {
    ...
    >
      <Card
        className={`overflow-hidden border-blue-200 ${
          isUrgent ? "bg-blue-100" : "bg-blue-50"
        }`}
      >
        {/* Header strip */}
        ...
        <div className="p-4">
          ...
          <p className="mt-4 text-xs text-blue-600/70">
            Delivery estimates are provided by HIF staff and may vary.
            Insha'Allah your order will arrive on time.
          </p>
        </div>
      </Card>
    </motion.div>
