...
export default function SettingsPage() {
  ...
  const [settings, setSettings] = useState({
    ...
    smsNotifications: profile?.notification_preferences?.smsNotifications ?? true,
    eventReminders: true,
    donationReceipts: true,
    newsletterUpdates: profile?.notification_preferences?.newsletter ?? true,
    language: "en",
  ...
  const handleSaveSettings = async () => {
    ...
    try {
      ...
      const notificationPreferences = {
        ...
        newsletter: settings.newsletterUpdates,
        eventReminders: settings.eventReminders,
        donationUpdates: settings.donationReceipts,
      }
